 ...
 * @author 孙宇
 */
public class KafkaConsumerUtilbak implements Serializable, Closeable {
     ...
     * @return
     */
    public KafkaConsumerUtilbak bootstrapServers(String servers) {
     ...
     * @return
     */
    public KafkaConsumerUtilbak groupId(String id) {
     ...
     * @return
     */
    public KafkaConsumerUtilbak topics(List<String> topics) {
        this.topics = topics;
        return this;
    }
     ...
     * @return
     */
    public KafkaConsumerUtilbak topic(String topic) {
     ...
     * @return
     */
    public static KafkaConsumerUtilbak builder() {
        return new KafkaConsumerUtilbak();
    }
     ...
     * @return
     */
    public KafkaConsumerUtilbak build(Properties config) {
        log.info("构建消费者工具开始");
        if (consumer != null) {
     ...
     * @return
     */
    public KafkaConsumerUtilbak build() {
